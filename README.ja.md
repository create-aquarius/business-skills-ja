...
**新しく2本を追加しました（試用版）。** [LPの根拠点検・不具合報告の整理](docs/two-review-skills.md)は、英語・日本語で使えます。入力例と出力例も公開しています。
...
| [`lp-claim-audit`](skills/lp-claim-audit/SKILL.md) | 商品資料とLPを照合し、裏付けのない実績・効果・料金説明を見つける |
| [`feedback-to-repro`](skills/feedback-to-repro/SKILL.md) | 不具合報告を、観測事実・再現手順・不足情報が分かるIssue下書きにする |
